...
public class decafV3Parser extends Parser {
	...
	public static class Id_tokContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof decafV3Listener ) ((decafV3Listener)listener).enterId_tok(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof decafV3Listener ) ((decafV3Listener)listener).exitId_tok(this);
		}
	}
